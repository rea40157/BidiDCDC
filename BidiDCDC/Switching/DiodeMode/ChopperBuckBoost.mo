...
model ChopperBuckBoost "Bidirectional chopper"
  ...
  Modelica.Electrical.Analog.Basic.Capacitor capacitorHV(C=CHV) annotation (
      Placement(transformation(
        ...
        rotation=270,
        origin={80,0})));
  PWMmode.LogicalDelay logicalDelayLV(delayTime=TDelay) annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={-60,-30})));
  PWMmode.LogicalDelay logicalDelayHV(delayTime=TDelay) annotation (Placement(
        transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={60,-30})));
equation
  ...
  connect(currentSensor.i, ILV)
    annotation (Line(points={{-20,49},{-20,-110}}, color={0,0,127}));
    ...
    Icon(graphics={
        Rectangle(
          ...
          fillPattern=FillPattern.Solid),
              ...
              -10,-8},{-4,-14},{-16,-20},{-20,-24},{-20,-60},{-20,-24},{-30,-24},
              {-30,8},{-20,-8},{-40,-8},{-30,8},{-20,8},{-40,8},{-30,8},{-30,24},
              {-20,24},{-20,60},{-20,24},{0,4}},
...
This is a bidirectional buck / boost - converter with 2 transistors and 2 freewheeling diodes.
    ...
    Diagram(graphics={
        Text(
          ...
          textString="MosfetHS"),
        Rectangle(extent={{30,94},{64,48}}, lineColor={28,108,200}),
        Text(
          extent={{-20,3},{20,-3}},
          textColor={28,108,200},
          origin={12,25},
